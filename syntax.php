...
define('FLOWPLAYER', DOKU_BASE.'lib/plugins/flowplayer/player/flowplayer-3.1.5.swf');
...
class syntax_plugin_flowplayer extends DokuWiki_Syntax_Plugin {
    ...
    function handle($match, $state, $pos, &$handler){
        ...
        $url = str_replace("%", "%25", $url); // Dirty hack for non-latin filenames
